<template>
  <header
    class="h-16 p-4 bg-default/75 backdrop-blur border-b border-default sticky top-0 z-50 flex items-center gap-4"
  >
    <div class="flex items-center gap-1.5 w-[300px]">
      <div
        class="router-link-active router-link-exact-active flex gap-2 items-end"
      >
        <div class="text-highlighted block w-auto h-6">
          <svg
        ...
        <span
          class="items-center px-1.5 py-1 gap-1 bg-primary/10 text-primary ring ring-inset ring-primary/25 hidden md:block -mb-[2px] rounded font-semibold text-[12px]/3"
          data-state="closed"
